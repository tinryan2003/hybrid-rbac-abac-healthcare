...
// Role and dashboard mapping. Role is read from session (Keycloak); list data from API.

export type Role = "admin" | "doctor" | "nurse" | "receptionist" | "patient" | "external_auditor" | "billing_clerk" | "lab_tech" | "pharmacist";
...
export const DASHBOARD_BY_ROLE: Record<Role, string> = {
  ...
  patient: "/patient",
  external_auditor: "/audit-logs",
  billing_clerk: "/billing-clerk",
  lab_tech: "/lab-tech",
  pharmacist: "/pharmacist",
};

// --- Mock data: only for list pages that do not yet have backend (subjects, classes, events, etc.) ---
...
// HMS aliases
export const doctorsData = teachersData;
export const patientsData = studentsData;
