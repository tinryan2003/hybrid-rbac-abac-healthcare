package org.vgu.appointmentservice.config;
        ...
        http
                ...
                .authorizeHttpRequests(authz -> authz
                        ...
                        .requestMatchers(
                                ...
                                "/actuator/info",
                                "/appointments/health",
                                "/api/appointments/pip/**"        // PIP - direct inter-service calls (no gateway strip)
                        ).permitAll()
                        
                        // All other API endpoints require authentication
                        .requestMatchers("/appointments/**", "/api/**").authenticated()
